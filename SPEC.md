...
| PZEM-004T RX | GPIO20 | UART1 RX ESP32 (к TX PZEM), 9600 бод |
| PZEM-004T TX | GPIO19 | UART1 TX ESP32 (к RX PZEM), 9600 бод |
...
Локальное управление выполняется через TFT touch, удалённое — через Web UI / MQTT / Telegram.
...
| Telegram (FastBot2), MQTT / HA | Готово |
