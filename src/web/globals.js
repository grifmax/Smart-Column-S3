...
export let runtimeMonitorState = {
    ...
    v2: {
        ...
        indicators: {
            ...
            columnSensorsAvailable: false,
            coolingSensorAvailable: false,
    ...
    equipment: {
        ...
        boosterHeaterEnabled: false,
        boosterHeaterPowerW: 3000,
        boosterHeaterStopCubeTempC: 78,
        coolingPwmEnabled: false,
        coolingPwmMinDuty: 0,
        coolingPwmMaxDuty: 255,
        coolingPwmStartupDuty: 96,
        coolingPwmCurrentDuty: 0,
        useDs2482ForTemps: false,
        ds2482Address: 24,
        tempBusGpioPin: 18,
        temperatureBusSource: 'gpio',
        temperatureBusSourceLabel: 'GPIO 1-Wire',
    ...
    rectification: {
        ...
        takeoffBackendActive: false,
        takeoffRoutingReady: true,
        takeoffRequestedEquivalentRateMlH: 0,
        takeoffActualEquivalentRateMlH: 0,
        takeoffRateLimited: false,
        takeoffActualDuty: 0,
        takeoffSessionVolumeMl: 0,
        takeoffRequestedFraction: 0,
        takeoffRoutedFraction: 0,
        takeoffActiveFraction: 0,
        takeoffActiveValve: 0,
        refluxMode: 0,
        srRatio: 0,
