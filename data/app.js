...
function positionTopMenuDropdown() {
    const dropdown = document.getElementById('top-menu-dropdown');
    const toggle = document.getElementById('top-menu-toggle');
...
function clampRectInput(value, min, max, fallback) {
...
function closeRectificationStartModal() {
    const modal = document.getElementById('rect-start-modal');
    if (modal) modal.style.display = 'none';
}

function updateRectificationFractionsSum() {
...
function applyRectificationFeedstockDefaults() {
...
function normalizeRectificationFractions(params) {
...
function collectRectificationModalSettings() {
    const params = {
...
async function openRectificationStartModal() {
    const modal = document.getElementById('rect-start-modal');
    if (!modal) {
...
async function confirmStartRectification() {
...
function initRectificationStartModal() {
    const modal = document.getElementById('rect-start-modal');
    if (!modal) return;
