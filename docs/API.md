...
Установить скорость без изменения состояния вкл/выкл.
...
Полный статус тестирования: блокировки, активные тесты, насос, ТЭН, клапаны, серво, сенсоры, питание.
