...
### 8. Reconnect/backoff для Telegram (TODO2.0.md)
...
### 12. Команда `/health` для Telegram (TODO2.0.md)

Уведомления о здоровье есть как push, но нет pull-команды. **Добавить в [telegram.cpp](file:///c:/Smart-Column-S3-claude-smart-column-s3-01BtHoqGVyMaVAPXERRPFJq7/Smart-Column-S3-claude-smart-column-s3-01BtHoqGVyMaVAPXERRPFJq7/src/interface/telegram.cpp):**
...
- **Logging macros** (LOG_E/LOG_W/LOG_I/LOG_D) с уровнями
