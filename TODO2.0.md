...
**Версия прошивки:** 2.1.18 | **Дата:** 2026-04-15
...
### Мешалка (новое, v2.1.18)

- [ ] **API endpoints** — `/api/stirrer/start`, `/api/stirrer/stop`, `/api/stirrer/set` в webserver.cpp
- [ ] **NVS сохранение** настроек мешалки — загрузка/сохранение через `nvs_manager.cpp`
- [ ] **Web UI виджет** — слайдер скорости мешалки + статус-индикатор на главной странице
- [ ] **Настройки в Web UI** — вкладка «Оборудование» → «Параметры» → секция «Мешалка»
...
### v2.2.x — Мешалка + UI
- Виджет управления мешалкой на главной странице
- NVS настройки мешалки
- Полный UI тестирования мешалки в сервисном экране

### v2.3.x — Финализация UI
